...
//  Gallery
//
//  Created by Максим Чесников on 16.12.2019.
...
//        }
    ...
    func downloadImages(){
        var schet = 0
        Alamofire.request("http://gallery.dev.webant.ru/api/photos?new=true&popular=false").responseJSON { responseJSON in
